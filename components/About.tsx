          ...
          <div className="grid grid-cols-4 items-center gap-12">
            ...
            <div className="col-span-3">
              <h1 className="font-heading text-5xl font-semibold tracking-tight">
                <span className="text-primary-500">Naimul Haque</span>
              </h1>
              ...
              <div className="mt-6 flex gap-4 text-sm">
                <a
                  ...
                  className="flex items-center space-x-1 rounded-md bg-orange-100 px-2.5 py-1.5 font-medium text-orange-700"
                >
                  <svg
                    ...
                    strokeWidth="1.5"
                    className="h-5 w-5 stroke-orange-700"
                    viewBox="0 0 24 24"
                  >
                ...
                <a
                  ...
                  className="flex items-center space-x-1 rounded-md bg-sky-100 px-2.5 py-1.5 font-medium text-sky-600"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="44"
                    ...
                    strokeLinejoin="round"
                    strokeWidth="1.5"
                    className="h-5 w-5 stroke-sky-600"
                    viewBox="0 0 24 24"
                  >
                    <path stroke="none" d="M0 0h24v24H0z"></path>
