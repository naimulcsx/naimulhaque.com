...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] relative isolate h-full transition-transform will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
    ...
    >
      <div className="delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] grid h-full origin-center rounded-[var(--radius)] border border-slate-800 transition-transform will-change-transform [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] hover:filter-none hover:[--duration:200ms] hover:[--easing:linear] hover:[--opacity:0.6]">
        ...
        <div className="transition-background will-change-background delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] grid w-full opacity-[var(--opacity)] mix-blend-soft-light transition-opacity [background:radial-gradient(farthest-corner_circle_at_var(--m-x)_var(--m-y),_rgba(255,255,255,0.8)_10%,_rgba(255,255,255,0.65)_20%,_rgba(255,255,255,0)_90%)] [clip-path:inset(0_0_1px_0_round_var(--radius))] [grid-area:1/1]" />
        <div
