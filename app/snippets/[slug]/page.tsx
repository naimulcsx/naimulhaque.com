        ...
        <Container>
          <div className="mt-32 lg:mt-40 lg:mb-20">
            <div className="space-y-2">
              <h1 className="pb-0 text-4xl font-bold text-slate-200">
                {snippet.title}
              </h1>
              <p>{snippet.summary}</p>
            </div>
            <article className="mt-8 prose col-span-7 max-w-none space-y-6 dark:prose-invert lg:prose-lg lg:col-span-5">
